...
def part1(trainin,testin,output,weight):
    ...
    np.savetxt(sys.argv[3],preder,delimiter=',',fmt='%s')
    np.savetxt(sys.argv[4],[[p for p in line] for line in weights],delimiter=',',fmt='%s')
